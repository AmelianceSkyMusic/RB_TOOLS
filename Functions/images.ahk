...
; isImageWaitForImgClick_FC(img_path, img_name, plus_click_x, plus_click_y, clicks:=1, moveBack:=true, speed:=0, sleepSet:=0, x1:=0, y1:=0, x2:=-100000, y2:=-100000) {
...
; 	CoordMode "Mouse", "Screen"
; 	MouseGetPos(&start_xpos, &start_ypos)
; 	Msg "x: " start_xpos " ,y: " start_ypos, 3000
