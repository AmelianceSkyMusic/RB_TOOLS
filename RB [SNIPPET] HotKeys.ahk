...
; {
;     e::        Send "!+9" ;               Set English language
;     r::        Send "!+0" ;               Ser Russian language

;     h::        Send "{U+20BD}" ;          ₽   Ruble sign

;     x::        Send "{U+00D7}" ;          ×  Multiplication Sign
;     =::        Send "{U+00B1}" ;          ±  Plus minus symbol

;     Up::       Send "{U+2191}" ;          ↑  Upwards Arrow
;     Down::     Send "{U+2193}" ;          ↓  Down arrow
;     Left::     Send "{U+2190}" ;          ←  Leftwards Arrow
;     Right::    Send "{U+2192}" ;          →  Rightwards Arrow

;     -::        Send "{U+2013}" ;          –  En Dash
;     >+-::      Send "{U+2014}" ;          —  Em Dash

;     .::        Send "{U+00BB}" ;          «  Left-Pointing Double Angle Quotation Mark
;     ,::        Send "{U+00AB}" ;          »  Right-Pointing Double Angle Quotation Marke
; }
...
;     i::        Send "{Up}" ;              Up
; 	<!i::      Send "^{Up}" ;             Ctrl Up
; 	<!<+i::    Send "^+{Up}" ;            Ctrl Shift Up
	
;     k::        Send "{Down}" ;            Down
;     <!k::      Send "^{Down}" ;           Ctrl Down
;     <!<+k::    Send "^+{Down}" ;          Ctrl Shift Down
	
;     j::        Send "{Left}" ;            Left
; 	<!j::      Send "^{Left}" ;           Ctrl Left
; 	<!<+j::    Send "^+{Left}" ;          Ctrl Shift Left

;     l::        Send "{Right}" ;           Right
; 	<!l::      Send "^{Right}" ;          Ctrl Right
; 	<!<+l::    Send "^+{Right}" ;         Ctrl Shift Right
...
;     x::        Send "{Numpad2}" ;         2
;     c::        Send "{Numpad3}" ;         3
;     v::        Send "{NumpadDot}" ;       NumDot
;     b::        Send "{NumpadEnter}" ;     NumEnter
; 	Space::    Send "{Numpad0}" ;         0
; 	2::        Send "{Backspace}" ;       Backspace
;     1::        Send "{Del}" ;             Delete

;     SC027::    Send "{Backspace}" ;       Backspace
; 	<!SC027::  Send "^{Backspace}" ;      Ctrl + Backspace
;     p::        Send "{Del}" ;             Delete
; }
